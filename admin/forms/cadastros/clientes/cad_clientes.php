                    ...
                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                        ...
                        <div class="form-row">
                            <div class="col-md-1 mb-3">
                                ...
                                <select class="custom-select form-control form-control-sm" id="pessoa" name="pessoa" required>
                            ...
                            <div class="col-md-4 mb-3">
                                <label for="validationCustom01">Nome/Razão</label>
                                <input type="text" class="form-control form-control-sm" name="clinomerazao" id="validationCustom01" placeholder="Nome/Razão" required>
