    ...
    <table class="table table-sm table-hover">
        ...
        <?php while ($linhas = mysqli_fetch_array($resultado)){?>
            <tr>
                ...
                <td><?php echo $linhas['clifone1']?></td>
                <td><?php echo $linhas['clifone2']?></td>
                <td><?php echo $linhas['clifone3']?></td>
...
<script language="JavaScript">
    ...
    function deletecliente(delid) {
        var resposta = confirm("Deseja realmente excluir o cliente ?");
        if (resposta == true){
            window.location.href = "processa/cadclientes/pro_exclui_cliente.php?del_id="+delid;
        }
    }
    // CHECKBOX NA GRID
